...
<header id="masthead" className="site-header header-v1" style={{backgroundImage: 'none'}}>
  ...
  <div className="header-wrap">
    ...
    <div className="header-info-wrapper">
      <div className="header-phone-numbers">
        <span className="intro-text">Call and Order in</span>
        <select className="select-city-phone-numbers" name="city-phone-numbers" id="city-phone-numbers">
        ...
        <span id="city-phone-number-label" className="phone-number">54 548 779 654</span>
      </div>
      <ul className="site-header-cart-v2 menu">
        <li className="cart-content ">
          <a href="cart.html" title="View your shopping cart">
            <i className="po po-scooter" />
            <span>Go to Your Cart</span>
          </a>
          <ul className="sub-menu">
            <li>
              <a href="cart.html" title="View your shopping cart">
                <span className="count">2 items</span> <span className="amount">$50.00</span>
              </a>
            </li>
          </ul>
        </li>
