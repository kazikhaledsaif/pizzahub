        ...
        <div className="col-full">
          <div className="footer-social-icons">
            ...
            <ul className="social-icons list-unstyled">
              ...
              <li><a className="fa fa-youtube" href="#" /></li>
              <li><a className="fa fa-dribbble" href="#" /></li>
            </ul>
          </div>
          ...
          <div className="site-info">
            <p className="copyright">Copyright © 2017 Pizzaro Template. All rights reserved.</p>
          </div>
          {/* .site-info */}      <a role="button" className="footer-action-btn" data-toggle="collapse" href="#footer-map-collapse"><i className="po po-map-marker" />Find us on Map</a>
          <div className="pizzaro-handheld-footer-bar">
            <ul className="columns-3">
                ...
                <div className="site-search">
                  <div className="widget woocommerce widget_product_search">
                    <form role="search" method="get" className="woocommerce-product-search">
                      <label className="screen-reader-text" htmlFor="woocommerce-product-search-field">Search for:</label>
                      <input type="search" id="woocommerce-product-search-field" className="search-field" placeholder="Search Products…" defaultValue name="s" title="Search for:" />
              ...
              <li className="cart">
                <a className="footer-cart-contents" href="cart.html" title="View your shopping cart">
